...
import logging
import numpy as np
# Import milvus_lite before MilvusClient to ensure it's available for local connections
try:
    import milvus_lite
except ImportError:
    raise ImportError("milvus-lite is required for local database connections. Please install it with: pip install pymilvus[milvus_lite]")
